class SummonerMatch {
  ...
  SummonerMatch({metadata, this.info});

  SummonerMatch.fromJson(Map<String, dynamic> json) {
    metadata =
...
class Styles {
  ...
  Styles({description, selections, style});
...
class Selections {
  ...
  Selections({perk, var1, var2, var3});
...
class Teams {
  ...
  Teams({bans, objectives, teamId, win});
...
class Objectives {
  ...
  Objectives.fromJson(Map<String, dynamic> json) {
    ...
    riftHerald =
        json['riftHerald'] != null ? Baron.fromJson(json['riftHerald']) : null;
